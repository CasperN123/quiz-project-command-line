...
--
-- Host: localhost
-- Generation Time: Jun 14, 2018 at 11:08 PM
...
--
-- Stand-in structure for view `ListQuestionsAnswerAndSmartUsers`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `ListQuestionsAnswerAndSmartUsers`;
CREATE TABLE `ListQuestionsAnswerAndSmartUsers` (
`questionID` int(11)
,`text` varchar(255)
